...
export default function BottomNavButton({ currentPage, onClick }: BottomNavButtonProps) {
    return (
        <div>
            ...
            {currentPage == 0 ? <button onClick={onClick} className="border-l-2 border-t-2 border-r-2 border-b-2 block sm:hidden absolute bottom-0 sm:left-0 left-1/4 sm:right-0 right-1/4 sm:w-full h-12 flex p-1 items-center justify-center cursor-pointer hover:bg-red-300 font-bold hover:italic hover:border-t-2 hover:border-l-2 hover:border-r-2 border-black">
