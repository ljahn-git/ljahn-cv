...
export default function LeftNavButton({ currentPage, onClick }: LeftNavButtonProps) {
    return (
        <div>
            {currentPage == 0 ? <button onClick={onClick} className="hidden sm:block absolute top-0 bottom-0 h-full w-12 flex flex-col p-1 items-center justify-center cursor-pointer font-bold hover:italic hover:bg-red-300 hover:border-r-2 border-black">
